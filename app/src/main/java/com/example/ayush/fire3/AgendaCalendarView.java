...
import com.example.ayush.fire3.agenda.AgendaAdapter;
import com.example.ayush.fire3.agenda.AgendaView;
import com.example.ayush.fire3.calendar.CalendarView;
...
import com.example.ayush.fire3.render.DefaultEventRenderer;
import com.example.ayush.fire3.render.EventRenderer;
import com.example.ayush.fire3.utils.BusProvider;
import com.example.ayush.fire3.utils.Events;
import com.example.ayush.fire3.utils.ListViewScrollTracker;
import com.example.ayush.fire3.widgets.FloatingActionButton;
...
public class AgendaCalendarView extends FrameLayout implements StickyListHeadersListView.OnStickyHeaderChangedListener {
    ...
    public AgendaCalendarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a;
        a = context.obtainStyledAttributes(attrs, R.styleable.ColorOptionsView, 0, 0);
    ...
    public void addEventRenderer( final EventRenderer<?> renderer) {
