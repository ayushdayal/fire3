package com.example.ayush.fire3.calendar;
...
import com.example.ayush.fire3.R;
import com.example.ayush.fire3.calendar.weekslist.WeekListView;
import com.example.ayush.fire3.calendar.weekslist.WeeksAdapter;
...
public class CalendarView extends LinearLayout {
    ...
    public CalendarView(Context context, AttributeSet attrs) {
        ...
        if (inflater != null) {
            ...
            Log.d("erorFacedEarlierAlso", "CalendarView: infltorr failed line:71");
        }
